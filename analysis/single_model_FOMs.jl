...
p1 = plot_relationship(results["camelyon17"], "test_performance", "test_robustness", p=plot(title="Test Robustness vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Robustness"))
p2 = plot_relationship(results["iwildcam"], "test_performance", "test_robustness", p=plot(title="Test Robustness vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Robustness"))
p3 = plot_relationship(results["fmow"], "test_performance", "test_robustness", p=plot(title="Test Robustness vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Robustness"))
p4 = plot_relationship(results["rxrx1"], "test_performance", "test_robustness", p=plot(title="Test Robustness vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Robustness"))
plot(p1, p2, p3, p4, layout=(1, 4), size=(4*400, 400))

# Performance and calibration
p1 = plot_relationship(results["camelyon17"], "test_performance", "test_calibration", p=plot(title="Test Calibration vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Calibration"))
p2 = plot_relationship(results["iwildcam"], "test_performance", "test_calibration", p=plot(title="Test Calibration vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Calibration"))
...
p2 = plot_relationship(results["iwildcam"], "test_performance", "test_security", p=plot(title="Test Security vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Security"))
p3 = plot_relationship(results["fmow"], "test_performance", "test_security", p=plot(title="Test Security vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Security"))
p4 = plot_relationship(results["rxrx1"], "test_performance", "test_security", p=plot(title="Test Security vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Security"))
plot(p1, p2, p3, p4, layout=(1, 4), size=(4*400, 400), dpi=300)

# Performance and fault detection
p1 = plot_relationship(results["camelyon17"], "test_performance", "test_ood_detection", p=plot(title="Test Fault Detection vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Fault Detection"))
p2 = plot_relationship(results["iwildcam"], "test_performance", "test_ood_detection", p=plot(title="Test Fault Detection vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Fault Detection"))
p3 = plot_relationship(results["fmow"], "test_performance", "test_ood_detection", p=plot(title="Test Fault Detection vs ID-Test Performance", xlabel="ID-Test Performance", ylabel="Test Fault Detection"))
